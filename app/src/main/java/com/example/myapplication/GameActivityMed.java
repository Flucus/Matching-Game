...
public class GameActivityMed extends AppCompatActivity implements View.OnClickListener {

    private TextView tvMoves;
    private int moveCount;

    private Button prevButton, btnContinue, btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btn10, btn11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_med);
        ...
        mysong = MediaPlayer.create(this, R.raw.game_music_med);
        mysong.start();
            ...
            if (prevButton == null) {
                ...
                if (items.get(Integer.parseInt(prevButton.getTag().toString())).equals(item)) {
                    ...
                    if (pairsFound == 6) {
                        ...
                        tvMoves.setText("Finished Medium Level!\nMoves: " + moveCount + "\nTime: " + formattedDuration + "s");
    ...
    private void startTimer(long duration) {
        timer = new CountDownTimer(duration, 1) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                tvMoves.setText("Medium - Moves: " + moveCount + " Time: " + formattedSeconds + "s");
            }

            @Override
            public void onFinish() {
                tvMoves.setText("Medium Level - GAME OVER!");
