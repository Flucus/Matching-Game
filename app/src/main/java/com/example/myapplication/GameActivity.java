...
public class GameActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button prevButton, btnContinue, btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btnBackToMenu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mysong = MediaPlayer.create(this, R.raw.game_music);
        mysong.start();
            ...
            if (prevButton == null) {
                ...
                if (items.get(Integer.parseInt(prevButton.getTag().toString())).equals(item)) {
                    ...
                    if (pairsFound == 4) {
                        ...
                        tvMoves.setText("Finished Easy Level!\nMoves: " + moveCount + "\nTime: " + formattedDuration + "s");
    ...
    private void startTimer(long duration) {
        timer = new CountDownTimer(duration, 1) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                tvMoves.setText("Easy - Moves: " + moveCount + " Time: " + formattedSeconds + "s");
            }

            @Override
            public void onFinish() {
                tvMoves.setText("Easy Level - GAME OVER!");
